...
public class Order {
    ...
    public Order(int id, int customerId, String orderPlacedDate, String orderDeliveredDate, int quantity, double totalPrice, String productName, String paymentType, int rating, String orderStatus) {
        this.id = id;
        this.customerId = customerId;
        this.orderPlacedDate = orderPlacedDate;
        this.orderDeliveredDate = orderDeliveredDate;
