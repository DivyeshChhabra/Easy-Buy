...
public class SellerUtility {
    ...
    public void addSeller(Seller seller) throws SQLException{
        ...
        try{
            ...
            String sql = "INSERT INTO seller(member_id,store_description,business_name,gstin,verified) VALUES(?,?,?,?,?)";
    ...
    public Seller getSeller(int memberID) throws SQLException {
        ...
        try{
            ...
            String sql = "SELECT * FROM seller WHERE member_id = ?";
            statement = connection.prepareStatement(sql);
    ...
    public int getSellerId(int memberID) throws SQLException {
        ...
        try{
            ...
            String sql = "SELECT id FROM seller WHERE member_id = ?";
            statement = connection.prepareStatement(sql);
            statement.setInt(1, memberID);
