                                ...
                                <table class="table my-0">
                                    ...
                                    <c:forEach var="order" items="${my_orders}">
                                        <tr>
                                            ...
                                            <td class="text-center <c:if test='${order.getOrderStatus().equals("Pending")}'>text-danger</c:if>
                                                                   <c:if test='${order.getOrderStatus().equals("Delivered")}'>text-success</c:if>">${order.getOrderStatus()}</td>
                                            <td class="text-center">
                                                <c:if test="${order.getOrderStatus().equals('Delivered')}">
