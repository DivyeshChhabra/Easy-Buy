...
public class CustomerUtility {
    ...
    public void addCustomer(Customer customer) throws SQLException{
        ...
        try{
            ...
            String sql = "INSERT INTO customers(member_id,billing_address,delivery_address) VALUES(?,?,?)";
    ...
    public Customer getCustomer(int memberID) throws SQLException {
        ...
        try{
            ...
            String sql = "SELECT * FROM customers WHERE member_id = ?";
            statement = connection.prepareStatement(sql);
    ...
    public int getCustomerId(int memberID) throws SQLException {
        ...
        try{
            ...
            String sql = "SELECT customer_id FROM customers WHERE member_id = ?";
            statement = connection.prepareStatement(sql);
            statement.setInt(1, memberID);
    ...
    public void updateCustomer(Customer customer) throws SQLException {
        ...
        try{
            ...
            String sql = "UPDATE customers SET billing_address = ?, delivery_address = ? WHERE member_id = ?";
            statement = connection.prepareStatement(sql);
