...
public class ProductUtility {
    ...
    public void addProduct(Product product) throws SQLException{
        ...
        try{
            ...
            String sql = "INSERT INTO products(product_name,product_description,category_id,seller_id,unit_price,discount,units_left,product_image,rating,review_count) VALUES(?,?,?,?,?,?,?,?,?,?)";
    ...
    public List<Product> getProducts() throws SQLException{
        ...
        try{
            ...
            while(resultSet.next()){
                ...
                String sellerSQL = "SELECT first_name, last_name FROM members JOIN sellers on members.member_id = sellers.member_id WHERE sellers.seller_id = ?";
                ...
                String categorySQL = "SELECT category_name FROM category WHERE category_id = ?";
    ...
    public void updateProduct(Product product) throws SQLException {
        ...
        try{
            ...
            String sql = "UPDATE products SET product_name = ?, product_description = ?, category_id = ?, seller_id = ?, unit_price = ?, discount = ?, units_left = ?, product_image = ?, rating = ?, review_count = ? WHERE product_id = ?";
            statement = connection.prepareStatement(sql);
            statement.setString(1, product.getName());
            statement.setString(2, product.getDescription());
            statement.setInt(3, product.getCategoryId());
